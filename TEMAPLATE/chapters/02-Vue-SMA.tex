...
% -----------------------------------------------------------------------------
\section{Recensement des agents dans \emph{omega-remote-paging}}
...
\bottomrule
\end{tabular}
\caption{Recensement des agents de \emph{omega-remote-paging}.}
...
\end{tikzpicture}
\caption{Topologie d'interaction multi-agents de \emph{omega-remote-paging}.}
