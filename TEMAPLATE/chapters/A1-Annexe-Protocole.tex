...
Cette annexe consigne la spécification complète du protocole binaire inter-nœuds utilisé par \emph{omega-remote-paging}. Elle est destinée à un éventuel ré-implémenteur (par exemple, pour ajouter un client de test en Python ou un backend store écrit dans un autre langage).
